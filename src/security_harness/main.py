...
def main():
    ...
    parser.add_argument("--analysis_count", type=int, default=None, help="Number of analysis rounds to run after ranking (0 = skip, -1 = unlimited, default = 2x the number of files in the project)")
